...
public class QuaterniondTest
{
	...
	public void testRotations()
	{
        ...
        tmpQ.set(new AxisAngle4d(new javax.vecmath.Vector3d(1,0,-1),Math.PI));
...
//            System.out.println( rotMethod + ": " + vq + " ==> " + vector3dEquals(vResult, vq, 1e-8));
            ...
            System.out.println( rotMethod + ": " + vm + " ==> " + vector3dEquals(vResult,vm,1e-8));
	...
	@SuppressWarnings("unused")
	private void assertQuaterniondEquals(Quaterniond q1, Quat4d q2, double epsilon)
	{
		assertEquals(q1.x,q2.x,epsilon);
		assertEquals(q1.y,q2.y,epsilon);
		assertEquals(q1.z,q2.z,epsilon);
